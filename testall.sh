...
#databases with drbd
py.test test_IS60$INTEG_DB_common.py test_IS60_INTEG_DB_drbd.py test_IS60_INTEG_DB1_sockets.py --ssh-config=/tmp/sshconfig --hosts 128.168.160.190 -v -n4
py.test test_IS60$INTEG_DB_common.py test_IS60_INTEG_DB_drbd.py test_IS60_INTEG_DB2_sockets.py --ssh-config=/tmp/sshconfig --hosts 128.168.160.191 -v -n4
